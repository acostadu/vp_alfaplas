  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Factura Venta (FE) - </h3>
        <div class="box-tools">
      ...
      <!-- /.box-header -->
  		<div class="box-body table-responsive">
            ...
            <th></th>
  			...
  			@foreach ($fact_ventas_fe as $data)
  		    <tr>
  		      <td>{{ $data->empresa }}</td>
            ...
            <td>{{ $data->totalingreso }}</td>
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                  ...
                  <li><a href="#"><i class="fa fa-file-pdf-o"></i>Ver PDF</a></li>
                  <li><a href="#"><i class="fa fa-trash"></i>Borrar</a></li>
                </ul>
              </div>              
            </td>
  		    </tr>
      ...
      <div class="box-footer clearfix">
        <div class="pull-right">{{ $fact_ventas_fe->links() }}</div>
      </div>
    </div>
    <!-- /.box -->
  </div>
